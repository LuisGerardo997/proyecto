...
<head>
    ...
    <style>
        body {
            padding-top: 100px;
            background-image: url(images/cybersecurity-background.jpg);
                        ...
                        <div class="face front">
                            <div class="panel panel-default">
                                <form class="form-horizontal" action="application/config/database.php" method="post">
                                    ...
                                    <p class="text-center"> <img class="img-thumbnail" src="images/2000px-Applications-database.svg.png" style="width:40px;height:40px;"></p>
                                    </div>
                                    <div class="col-md-8">
