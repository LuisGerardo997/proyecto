  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Tipos de habitación</h3>
      </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>tipo_habitaciones/guardar' method="post" id="form">
          <div class="form-group col-sm-5 col-sm-offset-1">
            ...
            <input type="text" class="form-control" placeholder="Tipo de Habitación" name="tipo"/>
          </div>
          <div class="form-group col-sm-5">
            <label for="nombre">(S/.)Precio</label>
            <input type="number" class="form-control" placeholder="(S/.)" name="precio"/>
          </div>
