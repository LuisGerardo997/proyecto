  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Ubigeo</h3>
          </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>ubigeo/guardar' method="post" id="form">
          <div class="form-group col-sm-5 col-sm-offset-1">
            <label for="nombre">Cod_Ciudad</label>
            <input type="text" class="form-control" placeholder="Cod_Ciudad" name="Cod"/>
          </div>
            ...
            <div class="form-group col-sm-6 col-sm-offset-3">
                ...
                <input type="text" class="form-control" placeholder="Provincia" name="Nombre" id="Nombre"/>
            </div>
            <div class="form-group col-sm-6 col-sm-offset-3">
