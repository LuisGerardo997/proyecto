  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Tipo de Pago</h3>
      </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>tipo_habitaciones/guardar' method="post" id="form">
          <div class="form-group col-sm-5 col-sm-offset-1">
            ...
            <input type="text" class="form-control" placeholder="Escriba aqui..." name="FP"/>
          </div>
          <div class="form-group col-sm-5">
            <label for="nombre">Descripción</label>
            <input type="text" class="form-control" placeholder="Escriba aqui..." name="FP_DES"/>
          </div>
      <br/>
      <br/>
      <br/>
