  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Caja</h3>
          </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>area/guardar' method="post" id="form">
          <div class="form-group col-sm-5 col-sm-offset-1">
            <label for="nombre">Numero de Caja</label>
            <input type="number" class="form-control" placeholder="NumerodeCaja" name="NumerodeCaja" id="NumerodeCaja"/>
          </div>
