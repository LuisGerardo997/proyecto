  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Tipos de Transacción</h3>
      </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>tipo_habitaciones/guardar' method="post" id="form">
          <div class="form-group col-sm-5 col-sm-offset-1">
            <label for="nombre">Tipo_transaccion</label>
            <input type="text" class="form-control" placeholder="Escriba aquí..." name="TT"/>
          </div>
          <div class="form-group col-sm-5">
            <label for="nombre">Descripción</label>
            <input type="text" class="form-control" placeholder="Escriba aqui" name="TT_DES"/>
          </div>
      <br/>
      <br/>
      <br/>
