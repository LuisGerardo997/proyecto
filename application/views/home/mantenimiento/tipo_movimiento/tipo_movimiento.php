  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Tipos de Movimiento</h3>
      </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>tipo_personas/guardar' method="post" id="form">
          <div class="form-group col-sm-6 col-sm-offset-3">
            ...
            <input type="text" class="form-control" placeholder="TipodeMovimiento" id="TipodeMovimiento" name="TipodeMovimiento"/>
          </div>
      <br/>
      <br/>
      <br/>
