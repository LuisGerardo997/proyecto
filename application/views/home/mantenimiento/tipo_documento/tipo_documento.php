  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title" id="myModalLabel">Registro de Tipos de documento</h3>
      </div>
    </br>
    </br>
        <form class="form text-center" action='<?= base_url() ?>tipo_habitaciones/guardar' method="post" id="form">
          <div class="form-group col-sm-5 col-sm-offset-1">
            ...
            <input type="text" class="form-control" placeholder="Escriba aquí..." name="td_des"/>
          </div>
          <div class="form-group col-sm-5">
            <label for="nombre">Nro.Serie</label>
            <input type="number" class="form-control" placeholder="Escriba aqui" name="ns"/>
          </div>
        <div class="form-group col-sm-6 col-sm-offset-3">
          <label for="nombre">Nro.Correlativo</label>
          <input type="number" class="form-control" placeholder="Escriba aquí" name="nc"/>
        </div>
      <br/>
      <br/>
      <br/>
